...
### 1.1. 주제
영화를 수입·배급하는 회사는 한정된 정보로 영화를 구매합니다. 구매에 대한 위험은 이를 수입·배급하는 회사에서 부담해야 합니다. 그리고 이들은 수백, 더 나아가 수천 편의 영화를 사전에 확인해야 합니다. 이 문제를 해결하기 위해 영화관입장권통합전산망, 그리고 영화진흥위원회에서 제공하는 박스오피스 통계 데이터를 활용해 기계 학습 모델을 구현하였습니다. 이 모델은 영화의 한정된 정보로 영화 관객 수를 예측할 수 있습니다.
